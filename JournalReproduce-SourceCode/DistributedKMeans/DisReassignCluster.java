...
public class DisReassignCluster extends Task {
	...
	public DisReassignCluster()
	{
		...
		ins[0] = new InputPort("in0", Dataview.datatype.DATAVIEW_String, "This is a points split, ");
		ins[1] = new InputPort("in1", Dataview.datatype.DATAVIEW_String, "This is a centroid matrix");
		outs[0] = new OutputPort("out0", Dataview.datatype.DATAVIEW_String, "This is a new points split with new cluster number assigned.");				
	}
