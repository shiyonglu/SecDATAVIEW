...
public class DisKMeansInitialization extends Task{
	...
	public DisKMeansInitialization()
	{
		...
		ins[0] = new InputPort("in0", Dataview.datatype.DATAVIEW_String, "This is the input file which has no cluster number.");
		for (int i = 0; i < M; i++) {
			outs[i] = new OutputPort("out0", Dataview.datatype.DATAVIEW_String, "this is the output file which has cluster numbers, starting from 0 at the beginning");
		}
	}
