...
public class Port {
	...
	public final int DATAVIEW_int = 0;
	public final  int DATAVIEW_double = 1;
	public final  int DATAVIEW_String = 2;
	public final  int DATAVIEW_BigFile = 3;   // we  support big data computation
	public final  int DATAVIEW_MathVector = 4; 
	public final  int DATAVIEW_MathMatrix = 5; 
	public final  int DATAVIEW_HashMap = 6; // Key and value pairs, both of them of type String
	public final  int DATAVIEW_Table = 7; // a table of elements of type String */
	public final  int DATAVIEW_Boolean = 8;
	...
	/*
	 * setLocation is called by a workflow executor, who knows the path and file name that contains the data for this inputport. 
	 ...
	 * The task executor will determine the life cyle of this file: when to create it, and when to delete it to save 
	 * storagte of the VM.
	 */
	...
	public String getPortTypeName()
	{
		switch(porttype)
		{
			...
			case 8: return "DATAVIEW_Boolean";
