...
public class SshServerMain2 extends SshServerCliSupport {
	public static Lock lock = new ReentrantLock();
	public static Condition condition = lock.newCondition();
	
	public static SshServer sshd;
    public SshServerMain2() {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sshd = error ? null : setupIoServiceFactory(SshServer.setUpDefaultServer(), options, System.out, System.err, args);
        if (sshd == null) {
            error = true;
        }
      ...
      //  sshd.setPublickeyAuthenticator(AcceptAllPublickeyAuthenticator.INSTANCE);
        ...
        System.out.println("Starting SSHD on port " + port);
        sshd.start();
//        Thread.sleep(Long.MAX_VALUE); //// ISSUE?
        lock.lock();
        try {
        ...
        System.out.println("Exiting after a very (very very) long time");
    }
}