...
public class WorkflowPLanner_E2C2D_latest extends WorkflowPlanner{
	...
	public WorkflowPLanner_E2C2D_latest(Workflow workflow) {
		super(workflow);
	}
	...
	private ArrayList<VMI> createVMIsUtilizingUnusedTime(ArrayList<VMI> instancesWithoutUnusedTime) {
		...
		for (VMI vm : toBeDeletedVMi) {
			vmiUtilizingUnusedTime.remove(vm);
		}
