...
public class Algorithm2 extends Task {
	...
	public Algorithm2() {
		...
		ins[3] = new InputPort("in3", Dataview.datatype.DATAVIEW_double, "This is the forth input");
	...
	public void run(){
		...
		Double input3 = ((Double) ins[3].read1()).doubleValue();
//		Double.parseDouble((String) ins[2].read1());
