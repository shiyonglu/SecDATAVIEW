...
public class DisCalculateCentroidStep1 extends Task{
	...
	{ 
		...
		outs[0] = new OutputPort("out0", Dataview.datatype.DATAVIEW_String, "number of points per cluster & partial sum of each cluster");
		outs[1] = new OutputPort("out1", Dataview.datatype.DATAVIEW_String, "original input file "); 
	...
	public void run()
	{
		...
		outs[0].write1(pointsPerCluster + "XX" + partialSumPerCluster);
		outs[1].write1(input0);
