...
public class Partitioner extends Task{
	/*
	...
	public Partitioner()
	{
		super("Partitioner", "This is a task that implements partition the dataset. It has one inputports and two outputports.");
		ins = new InputPort[1];
