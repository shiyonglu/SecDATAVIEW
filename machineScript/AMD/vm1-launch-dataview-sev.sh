...
UEFI_BIOS_VARS="/home/mofrad-s/AMDSEV/distros/ubuntu-18.04/OVMF_VARS.fd"
#VNC_PORT=""
USE_VIRTIO="1"
...
add_opts "-netdev tap,id=mynet0,ifname=tap0,downscript=no -device e1000,netdev=mynet0,mac=52:55:00:d1:55:01"
